...
export default function Home() {
  ...
  const twitchConnectionState = !twitchStatus.connected ? "inactive" : twitchStatus.live ? "live" : "active";
  const twitchConnectionLabel = twitchConnectionState === "inactive" ? "TWITCH INAKTIV" : twitchConnectionState === "live" ? "STREAM AKTIV" : "TWITCH AKTIV";
  const twitchConnectionTitle = twitchConnectionState === "inactive" ? twitchStatus.message : twitchConnectionState === "live" ? `Twitch-Chat verbunden · #${twitchStatus.channel} ist live` : `Twitch-Chat verbunden · #${twitchStatus.channel} ist offline`;
    ...
    <main className={`broadcast-shell phase-${phase} theme-${themeId} ${overlayOnly ? "overlay-only" : themesOnly ? "theme-surface" : "control-surface"}`}>
      ...
      <header className="topbar glass-panel">
        ...
        <div className="status-cluster">
          ...
          {!overlayOnly && <div className={`twitch-connection twitch-${twitchConnectionState}`} title={twitchConnectionTitle}><i />{twitchConnectionLabel}</div>}
