...
class AppSettings:
    ...
    twitch_redirect_uri: str = "http://127.0.0.1:8765/api/twitch/callback"
    ...
    def normalized(self) -> AppSettings:
        ...
        self.twitch_redirect_uri = self.twitch_redirect_uri.strip()
        if not self.twitch_redirect_uri.startswith("http://127.0.0.1:"):
            self.twitch_redirect_uri = "http://127.0.0.1:8765/api/twitch/callback"
        return self
